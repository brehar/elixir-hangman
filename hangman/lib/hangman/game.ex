defmodule Hangman.Game do
  ...
  def score_guess(game = %Hangman.Game{turns_left: 1}, _bad_guess) do
    Map.put(game, :game_state, :lost)
  end

  def score_guess(game = %Hangman.Game{turns_left: turns_left}, _bad_guess) do
    %Hangman.Game{game | game_state: :bad_guess, turns_left: turns_left - 1}
  end
